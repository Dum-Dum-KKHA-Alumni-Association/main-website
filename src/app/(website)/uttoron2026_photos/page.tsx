...
const Uttoron2026Page = () => {
	return (
		<section>
			<Navbar />
			<Heading name={'Uttoron 2026 Photos'} />
				...
				<section className="flex w-full flex-col items-center justify-center">
					...
					<section className="flex w-full flex-col items-center justify-center text-center md:flex-row md:gap-4">
						<Link
							...
							href={'https://forms.gle/7BGnbs1j4BYQjRbdA'}
							target="_blank"
						>
						...
						<Link
							className="mt-5 w-full max-w-80"
							href={'https://forms.gle/XYY9pVhtht6FPtfcA'}
							target="_blank"
						>
							<Card className="w-full">
								<CardHeader className="flex w-full items-center pb-2">
...
export default Uttoron2026Page;
