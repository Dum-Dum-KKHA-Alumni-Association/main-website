	...
	return (
		<section className="mt-0 w-full bg-primary py-12 md:my-24">
			<section className="m-auto flex w-full max-w-7xl flex-col items-center justify-between px-5">
				<h2 className="text-center text-xl font-medium text-slate-100 lg:text-4xl">
					Dum Dum K. K. Hindu Academy Alumni Association
				</h2>
				<p className="mt-7 w-full max-w-7xl text-center text-lg leading-normal tracking-wider text-slate-300 md:mt-16 md:text-2xl md:leading-relaxed">
				...
				<p className="mt-7 w-full max-w-7xl text-center text-lg leading-normal tracking-wider text-slate-300 md:text-2xl md:leading-relaxed">
			...
			{/* <section className="mx-auto mt-7 grid w-full max-w-7xl grid-cols-1 md:grid-cols-2 md:gap-6 lg:grid-cols-2"> */}
			<section className="mx-auto mt-7 flex w-full max-w-7xl flex-col items-center justify-center gap-4 md:flex-row md:gap-36">
				<motion.section
					...
					className="flex w-fit flex-col items-center justify-end rounded-xl py-10 text-slate-300 antialiased transition-colors duration-500 ease-in-out"
				>
					<Clock size={45} />
				...
				>
					...
					<span className="text-lg">Alumines</span>
				</motion.section>
				{/* <motion.section
					initial={{ opacity: 0, y: '30%' }}
					whileInView={{ opacity: 1, y: '0' }}
