		...
		<section className="my-20 w-full lg:my-40">
			<section className="m-auto flex w-full max-w-6xl flex-col items-center justify-between px-5">
				<Header
					...
					paragraph="Welcome to our alumni community! We are dedicated to fostering connections between former students and creating opportunities for networking and growth."
				/>
